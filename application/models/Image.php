...
class Application_Model_Image {
	 ...
	 * @param string $_cropratio
	 */
	public function process($file, $_width = null, $_height = null, $_quality = "100", $_cropratio = null) {
		...
		$maxWidth		= (isset($_width)) ? (int) $_width : 0;
		...
		$quality	= (isset($_quality)) ? (int) $_quality : DEFAULT_QUALITY;
